...
df = pd.read_csv('mauna-loa/surface-discrete/surface_discrete_raw.txt', delim_whitespace=True, skiprows=147, na_values="-999.99")
...
df_extracted.to_json('mauna-loa/surface-discrete/surface_discrete.json', orient='records', date_format='iso')

# Create a filtered JSON file without NaN values
df_extracted.dropna().to_json('mauna-loa/surface-discrete/surface_discrete_no_nan.json', orient='records', date_format='iso')

# Convert to Markdown and save it
with open('mauna-loa/surface-discrete/surface_discrete.md', 'w') as md_file:
