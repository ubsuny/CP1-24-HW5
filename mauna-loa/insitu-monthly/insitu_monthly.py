...
df = pd.read_csv('mauna-loa/insitu-monthly/insitu_monthly_raw.txt', delim_whitespace=True, skiprows=158, na_values="-999.99")
...
df_extracted.to_json('mauna-loa/insitu-monthly/insitu_monthly.json', orient='records', date_format='iso')

# Create a filtered JSON file without NaN values
df_extracted.dropna().to_json('mauna-loa/insitu-monthly/insitu_monthly_no_nan.json', orient='records', date_format='iso')

# Convert to Markdown and save it
with open('mauna-loa/insitu-monthly/insitu_monthly.md', 'w') as md_file:
