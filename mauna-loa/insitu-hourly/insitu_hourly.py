...
df_extracted.to_json('mauna-loa/insitu-hourly/insitu_hourly.json', orient='records', date_format='iso')

# Create a filtered JSON file without NaN values
df_extracted.dropna().to_json('mauna-loa/insitu-hourly/insitu_hourly_no_nan.json', orient='records', date_format='iso')

# Convert to Markdown and save it
with open('mauna-loa/insitu-hourly/insitu_hourly.md', 'w') as md_file:
